...
import * as _threeModule from 'three';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.LegacyJSONLoader = void 0;
...
/*
  LegacyJSONLoader.prototype = Object.assign(Object.create(_threeModule.Loader.prototype), {
    ...
    parse: function () {
      var _BlendingMode = {
        NoBlending: _threeModule.NoBlending,
        NormalBlending: _threeModule.NormalBlending,
        AdditiveBlending: _threeModule.AdditiveBlending,
        SubtractiveBlending: _threeModule.SubtractiveBlending,
        MultiplyBlending: _threeModule.MultiplyBlending,
        CustomBlending: _threeModule.CustomBlending
      };

      var _color = new _threeModule.Color();

      var _textureLoader = new _threeModule.TextureLoader();

      var _materialLoader = new _threeModule.MaterialLoader();
      ...
      function createMaterial(m, texturePath, crossOrigin, manager) {
        ...
        var json = {
          uuid: _threeModule.MathUtils.generateUUID(),
        ...
        for (var name in m) {
          ...
          switch (name) {
            ...
            case 'flipSided':
              json.side = _threeModule.BackSide;
              break;

            case 'doubleSided':
              json.side = _threeModule.DoubleSide;
              break;
            ...
            case 'vertexColors':
              if (value === true) json.vertexColors = _threeModule.VertexColors;
              if (value === 'face') json.vertexColors = _threeModule.FaceColors;
              break;
      ...
      function loadTexture(path, repeat, offset, wrap, anisotropy, textures, texturePath, crossOrigin, manager) {
        ...
        if (repeat !== undefined) {
          ...
          if (repeat[0] !== 1) texture.wrapS = _threeModule.RepeatWrapping;
          if (repeat[1] !== 1) texture.wrapT = _threeModule.RepeatWrapping;
        }
        ...
        if (wrap !== undefined) {
          if (wrap[0] === 'repeat') texture.wrapS = _threeModule.RepeatWrapping;
          if (wrap[0] === 'mirror') texture.wrapS = _threeModule.MirroredRepeatWrapping;
          if (wrap[1] === 'repeat') texture.wrapT = _threeModule.RepeatWrapping;
          if (wrap[1] === 'mirror') texture.wrapT = _threeModule.MirroredRepeatWrapping;
        }
        ...
        var uuid = _threeModule.MathUtils.generateUUID();
      ...
      function parseModel(json, geometry) {
        ...
        while (offset < zLength) {
          vertex = new _threeModule.Vector3();
        ...
        while (offset < zLength) {
          ...
          if (isQuad) {
            faceA = new _threeModule.Face3();
            faceA.a = faces[offset];
            faceA.b = faces[offset + 1];
            faceA.c = faces[offset + 3];
            faceB = new _threeModule.Face3();
            ...
            if (hasFaceVertexUv) {
              for (i = 0; i < nUvLayers; i++) {
                ...
                for (j = 0; j < 4; j++) {
                  ...
                  uv = new _threeModule.Vector2(u, v);
            ...
            if (hasFaceVertexNormal) {
              for (i = 0; i < 4; i++) {
                normalIndex = faces[offset++] * 3;
                normal = new _threeModule.Vector3(normals[normalIndex++], normals[normalIndex++], normals[normalIndex]);
            ...
            if (hasFaceVertexColor) {
              for (i = 0; i < 4; i++) {
                colorIndex = faces[offset++];
                hex = colors[colorIndex];
                if (i !== 2) faceA.vertexColors.push(new _threeModule.Color(hex));
                if (i !== 0) faceB.vertexColors.push(new _threeModule.Color(hex));
              }
            }
            ...
            if (hasFaceVertexColor) {
              for (i = 0; i < 3; i++) {
                colorIndex = faces[offset++];
                face.vertexColors.push(new _threeModule.Color(colors[colorIndex]));
              }
            }
      ...
      function parseSkin(json, geometry) {
        ...
        if (json.skinWeights) {
          for (var i = 0, l = json.skinWeights.length; i < l; i += influencesPerVertex) {
            ...
            geometry.skinWeights.push(new _threeModule.Vector4(x, y, z, w));
          }
        }
        ...
        if (json.skinIndices) {
          for (var i = 0, l = json.skinIndices.length; i < l; i += influencesPerVertex) {
            ...
            geometry.skinIndices.push(new _threeModule.Vector4(a, b, c, d));
          }
        }
      ...
      function parseAnimations(json, geometry) {
        ...
        for (var i = 0; i < animations.length; i++) {
          var clip = _threeModule.AnimationClip.parseAnimation(animations[i], geometry.bones);
        ...
        if (geometry.morphTargets) {
          ...
          var morphAnimationClips = _threeModule.AnimationClip.CreateClipsFromMorphTargetSequences(geometry.morphTargets, 10);
      ...
      return function parse(json, path) {
        ...
        var geometry = new _threeModule.Geometry();
